...
def plugin_main(args, **kwargs):
    '''
    Runs the Behavior Classifier Cyvere app with the input of the irods object obj
    '''
    try:
        logger = args['logger']
        ...
        query_params = {"search": "Behavior Classifier (Verssa)"}
        ...
        request_body = {
            ...
            "name": "BehaviorClassifierAutomation",
            "app_id": app_id,
            "system_id": system_id,
            "debug": False,
